													...
													@foreach($result as $key=>$value)
														<tr class="gradeX odd"  id="{{ $value->id }}">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a title="Delete Product" onclick="return confirm('Are you sure? You want to delete this slider.')" href="{{ url('admin/slider/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
